...
export class RegisterDTO {
  ...
  @ApiProperty({ example: 'Password123', description: 'Password (8-15 characters)', minLength: 8, maxLength: 15 })
  @IsString()
  ...
  @ApiProperty({ example: '01234567890', description: 'Phone number', minLength: 11, maxLength: 11 })
  @IsString()
  ...
  @IsEnum(ROLE, { message: 'Role must be STUDENT, INSTRUCTOR, or ADMIN' }) // CHANGE THAT
