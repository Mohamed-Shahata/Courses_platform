export const AUTH_MESSAGES = {
  ...
  WE_HAVE_SENT_A_PASSWORD_CHANGE_LINK_TO_YOUR_EMAIL:"We have sent a password change link to your email; please check it.",
  ...
  NEW_PASSWORD_AND_CONFIRM_PASSWORD_NOT_MATCHING: "New password and confirm password is not matching",
